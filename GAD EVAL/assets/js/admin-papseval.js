document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadEvaluators() {
        try {
            ...
            evaluators.forEach(e => {
                // Debug each evaluator object
                console.log('Processing evaluator:', e);
                console.log('Full name value:', JSON.stringify(e.fullName));
    ...
    function viewCertificate(doc) {
        ...
        // Navigate to certificate viewing page
        window.open(`viewcert.html?${params.toString()}`, '_blank');
        
        // Alternative: If you want to navigate in the same window
        // window.location.href = `viewcert.html?${params.toString()}`;
    }
