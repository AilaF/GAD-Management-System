...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 30, 2025 at 11:21 AM
...
('ADMIN_001', 'System', 'Administrator', '1990-01-01', 'Ma', '0928263826', 'admin@gad.com', '$2y$10$SeQI0h71IIz/bQo8jh2bL.tfD6wfRjqlHzJcIAdL/Vn2RFfSajyd2');
...
INSERT INTO `enduser` (`userID`, `fname`, `lname`, `mname`, `dob`, `sex`, `contactNo`, `email`, `address`, `orgname`, `password`, `profile_photo`) VALUES
('001', 'Gaby', 'Molina', 'Cheruvim', '2019-05-16', 'F', '09123456789', 'gabymolina@usep.edu.ph', '123 st. Davao City', 'CIC', '12345', NULL),
('UID_0e65dd', 'aila', 'fernandez', 'f', NULL, '', '', 'af@email', NULL, NULL, '$2y$10$D7BcKX1.Kn5qPKw0bbBxLetwmoc4zg2EiRbfhBhyUoRlyKZJTS6Ii', NULL),
('UID_0f715a', 'Michelle ', 'Sumadia', 'P', NULL, '', '', 'michellesumadia@gmail.com', NULL, NULL, '$2y$10$ukQxFfLdMEzlIrXk4FUgIuFC82k5RnP1nB1BeNoUulViQ2TmY1NS6', NULL),
('UID_36bc95', 'lowi', 'molina', 'c', NULL, '', '', 'l@usep.com', NULL, NULL, '$2y$10$aTZjKKiPrqEgLVATS.pJS.sDecWITFJo1msKjbBXo2JMHDlYBSTE.', NULL),
...
('UID_5d45d4', 'Michelle', 'Sumadia', 'P', NULL, '', '', 'msumadia@usep.edu.ph', NULL, NULL, '$2y$10$L/lwUlxPxUPL6rt3xp46U.2FiYqGaaoKB64i8ToYP8FkyiC66lmEe', NULL),
('UID_69293b', 'Sofia', 'Molina', 'S', NULL, '', '', 'sofia@gaby.com', NULL, NULL, '$2y$10$LxESPDrSSwvP1guVCoDZsuKcjD.0uV3u5re1t3vLK6qVWSsr//3D.', NULL),
('UID_757e6e', 'faith', 'macion', 'c', NULL, '', '', 'mf@email', NULL, NULL, '$2y$10$JPtAjLJQJagMY9jeLQQMgOc7fV7VBZ/m4tVv0NvJEcJclmvB1ilqC', NULL),
...
('UID_a5260e', 'testname', 'test', 'c.', NULL, '', '', 'test@email', NULL, NULL, '$2y$10$QiBIpMDu986iijLUKZQI6.weaFLI6/HiF4PUb5SelOqSyDnmMvKc.', NULL);
...
INSERT INTO `evaluator` (`evaluatorID`, `fname`, `lname`, `dob`, `sex`, `contactNo`, `email`, `address`, `expertise`, `department`, `password`) VALUES
('E174816451', 'Segn Lee', 'Buslon', '0000-00-00', 'M', '12345678901', 'SBuslon@usep.edu.ph', '', 'Policy Development and Advocacy', 'CAS - College of Arts and', '$2y$10$ep7SNmVKjGBmoxAEcn2PuOkhFQZ80BQEZhS9PgC.fJcZd7W/PJA0S'),
('E174817375', 'Lady Aila', 'Aparejo', NULL, 'F', '09138219912', 'laaparejo@usep.edu.ph', NULL, 'GAD Specialist II', 'CAEc - College of Applied', '$2y$10$/YX3HT0Tk97mqC8CTy07VuSWC4GtxegwAdgr8oG7MOSY3XFeA3XgC'),
('E174817596', 'Cheruvim Gabrielle', 'Molina', NULL, 'F', '09876543211', 'cgmolina@usep.edu.ph', NULL, 'Senior GAD Specialist', 'CIC - College of Informat', '$2y$10$4R8eCtm6OHdMlJNjM48QHO/0SF7bWdfeV2Gm4HOHEP5Z3IM3DtueG'),
('E174817619', 'Louie Jay', 'Macion', NULL, 'M', '09998761217', 'lmacion@usep.edu.ph', NULL, 'GAD Specialist I', 'CoE - College of Engineer', '$2y$10$LUFWPYyC5S8fjhsfCJlvQe9Bl7mQh0XZEFu6tYHW0Cr4c6qpKm1dK'),
('E174817640', 'Michelle Faith', 'Sumadia', NULL, 'F', '09876543210', 'mfpsumadia@usep.edu.ph', NULL, 'GAD Specialist II', 'CT - College of Technolog', '$2y$10$6LiyanqE5ScaEoLyWX4IvecnDN5zjS3JXDslT6GarnsNPU5ltWDAK'),
('E174817647', 'Trisha Amor', 'Mae', NULL, 'F', '12345678901', 'TAmor@usep.edu.ph', NULL, 'GAD Analyst', 'CoE - College of Engineer', '$2y$10$C0K7ET4vMTni72tyVzu1..YmzqH.mVhEY0aqqlGuMfge76gxCThC2'),
('E174822368', 'Emmanuel', 'Braza', NULL, 'F', '12345677901', 'Ebraza@usep.edu.ph', NULL, 'GAD Analyst I', 'CED - College of Educatio', '$2y$10$zX8CxZUIQN3Q3fnuwqSk9uZC1L5UfDGUl/6jFciVwTHhJbcGF3qvG');
...
--
ALTER TABLE `score`
  ADD CONSTRAINT `fk_score_version` FOREIGN KEY (`versionID`,`itemID`) REFERENCES `scoresheetversions` (`versionID`, `itemID`) ON DELETE RESTRICT,
