    ...
    <div class="overlay" id="overlay"></div>
        ...
        <div class="action-bar">
            <div class="search-box">
                <form method="get" action="enduser.php">
                    <input type="search" class="search-input" name="search" placeholder="Search your documents..." value="<?php echo htmlspecialchars($search); ?>">
                </form>
            </div>
        ...
        <div class="files-section">
            ...
            <table class="files-table">
                ...
                <tbody>
                    ...
                    <tr data-has-cert="<?= (int)$pap['hasCertificate'] ?>" data-papsid="<?= htmlspecialchars($pap['papsID']) ?>">
                        <td>
                            <a class="file-link" href="<?= htmlspecialchars($pap['fileLink']) ?>" target="_blank" rel="noopener noreferrer">
            ...
            <div class="empty-state">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" style="margin-bottom: 16px; stroke: #cbd5e0;">
    ...
    <div id="uploadModal" class="modal-overlay" style="display: none;">
        <div class="modal">
            ...
            <div class="modal-description" style="font-size: 0.95em; color: #64748b; margin-bottom: 12px;">
                <p style="margin: 25px;">
                    Please fill out the form below with the necessary project details. Make sure to provide accurate information, including the project title, department, author, and the link to the supporting document.
                </p>
            </div>
