...
<body style>
        ...
        <div class="container">
            ...
            <div class="filters-container">
                ...
                <div class="search-sort">
                    <input type="text" class="search-box" placeholder="Search title..." id="searchInput" style="width:800px;">
                    <div class="sort-icon" id="sortToggle">
                        <span id="sortLabel">Newest First</span>
                        <svg viewBox="0 0 24 24" width="20" height="20">
                            <path d="M7,3 L7,21 M7,3 L11,7 M7,3 L3,7 M17,21 L17,3 M17,21 L21,17 M17,21 L13,17" stroke="#663399" stroke-width="2" fill="none" />
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <table class="documents-table">
                <thead>
                    <tr>
                        <th>Doc. No</th>
                        <th>College/Unit</th>
                        <th class="title-column" style="width: 50%; font-weight: 600; max-width: 500px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">Title</th>
    ...
    <div class="pagination-container">
        ...
        <div class="showing-entries">
            showing <span id="startEntry">1</span> to <span id="endEntry">5</span> out of <span id="totalEntries">6</span> entries
        </div>
    ...
    <script>
        ...
        // Function to navigate to evaluation form with document data
        ...
        // }).toString();
            ...
            //window.location.href = `evaluation-form.html?${queryParams}`;
        //}
